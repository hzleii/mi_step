...
users = ["1111", "2222"]
passwords = ["1111, "2222"]
min_steps = [30000, 30000]
max_steps = [35000, 35000]
...
def startStep():
    if len(users) == len(passwords):
        for user_mi, passwd_mi, min_step, max_step in zip(users, passwords, min_steps, max_steps):
            main(user_mi, passwd_mi, min_step, max_step)
            # print(user_mi)
            # print(passwd_mi)
    else:
        print("账号密码不匹配，本次不提交")
